 ...
 */
// Printing out weapon on falcon fails, because weapon property pertains only to the Fighter subclass. A subclass can inherit methods and properties from a superclass, while a superclass cannot  inherit from a subclass.
