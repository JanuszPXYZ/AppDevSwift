...
struct User {
    ...
    static var currentUser: User = User(userName: "Janusz", email: "januszpolowczyk19@gmail.com", age: 26)
 ...
 */
let newUser = User(userName: "Mark", email: "markspace@hotmail.com", age: 26)
