...
print("My favorite book is \(favoriteBook.title) written by \(favoriteBook.author). It has \(favoriteBook.pages) pages and costs \(favoriteBook.price)")
 ...
 */
var myHeight = Height(heightInCentimeters: 184)
