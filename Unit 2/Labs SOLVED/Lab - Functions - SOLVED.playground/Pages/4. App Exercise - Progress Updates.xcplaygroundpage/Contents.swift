...
progressUpdate(steps: 850, goal: 10000)
progressUpdate(steps: 3700, goal: 10000)
progressUpdate(steps: 5000, goal: 10000)
progressUpdate(steps: 8700, goal: 10000)
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double){
    // function should calculate whether or not the user is on pace to hit or beat goalTime
...
pacing(currentDistance: 900, totalDistance: 1500, currentTime: 60, goalTime: 1020)
pacing(currentDistance: 900, totalDistance: 1500, currentTime: 860, goalTime: 1020)
