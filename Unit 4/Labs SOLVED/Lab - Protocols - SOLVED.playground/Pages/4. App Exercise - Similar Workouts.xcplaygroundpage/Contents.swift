...
let morningRun = RunningWorkout(distance: 1500, time: 580)
let afternoonSwim = SwimmingWorkout(distance: 1200, time: 876)

simpleWorkoutDescription(workout: morningRun)
simpleWorkoutDescription(workout: afternoonSwim)
