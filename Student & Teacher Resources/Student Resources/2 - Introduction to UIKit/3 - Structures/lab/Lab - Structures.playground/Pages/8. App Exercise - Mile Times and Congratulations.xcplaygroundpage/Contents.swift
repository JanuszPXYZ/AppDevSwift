...
struct RunningWorkout {
    ...
    var averageMileTime: Double {
        let mile: Double = distance / 1600
        return time / mile
    }
}

var runWork = RunningWorkout(distance: 5000, time: 1200, elevation: 13)
print(runWork.averageMileTime)
...
var goal = Steps(steps: 9999, goal: 10000)
goal.takeStep()
