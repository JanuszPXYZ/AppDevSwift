 ...
 */
let friends: [String] = ["Jane", "Caroline", "Mark", "Aaron", "Nellie"]

let funcSorted = friends.sorted(by: forwards(name1:name2:))
/*:
 ...
 */
let friendsSorted = friends.sorted { (name1, name2) -> Bool in
    return name1 < name2
}
 ...
 */
let sortedCollection3 = friends.sorted { $0 < $1 }
sortedCollection3
