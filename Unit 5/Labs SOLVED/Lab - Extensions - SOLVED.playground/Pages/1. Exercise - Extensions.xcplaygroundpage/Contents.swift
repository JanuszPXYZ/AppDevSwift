...
extension Character {
    func isVowel() -> Bool {
        ...
        for vowel in vowels {
            if Character.lowercased(self)() == vowel.lowercased() {
                return true
                }
            }
        return false
...
//
//for char in letters {
//    print("\(Character(extendedGraphemeClusterLiteral: char)) - \(Character(extendedGraphemeClusterLiteral: char).isVowel())")
//}
