...
//  PersonalityQuiz
//
//  Created by Janusz Polowczyk on 07/10/2020.
...
class QuestionViewController: UIViewController {
    ...
    // It is best to position the elements from a particular stack view below the stack view outlet. Makes the code cleaner.
    ...
    @IBAction func rangedAnswerButtonPressed(_ sender: Any) {
        let currentAnswers = questions[questionIndex].answers
        let sliderIndex = Int(round(rangedSlider.value * Float(questions.count) - 1))
