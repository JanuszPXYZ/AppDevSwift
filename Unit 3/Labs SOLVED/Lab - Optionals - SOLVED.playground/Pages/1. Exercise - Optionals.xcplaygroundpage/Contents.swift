 ...
 */
// Because the userInputAge cannot be converted to an Int. The failable initializer for the Int returns a value when it is possible to convert it to an Int, otherwise it returns nil
