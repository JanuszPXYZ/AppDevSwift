...
func mealLog(meal: String) -> Meal? {
    if let loggedMeal = meals[meal] {
        return loggedMeal
    }
    return nil
}

print(mealLog(meal: "Breakfast"))
print(mealLog(meal: "Lunch"))
print(mealLog(meal: "Dinner"))
/*:
 ...
 */
func savedMeal(meal: [String: Meal], key: String) -> [String: Any]? {
    if let savedMeal = UserDefaults.standard.dictionary(forKey: key) {
        return savedMeal
    }
    return nil
}

savedMeal(meal: meals, key: "Breakfast")

func loggedMeals(meal: [String: Meal], key: String) -> [String: Any]? {
    UserDefaults.set(meal, forKey: key)


}

loggedMeals(meal: meals, key: "Breakfast")
